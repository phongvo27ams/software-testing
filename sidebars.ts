...
const sidebars: SidebarsConfig = {
  blackBoxSidebar: [
    'black-box-testing/index',
    {
      ...
      link: {type: 'doc', id: 'black-box-testing/boundary-value-analysis/index'},
      items: [
        'black-box-testing/boundary-value-analysis/index',
    ...
    },
    {
      ...
      link: {type: 'doc', id: 'black-box-testing/equivalence-class-partitioning/index'},
      items: [
        'black-box-testing/equivalence-class-partitioning/index',
  ...
  testAutomationSidebar: [
    'test-automation/index',
    {
      ...
      link: {type: 'doc', id: 'test-automation/pending-topics/index'},
      items: [
        'test-automation/pending-topics/index',
